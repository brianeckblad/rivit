...
echo ""
echo "2. Marketplace Account Deletion Endpoint:"
echo "   https://your-domain.com/api/ebay/marketplace-account-deletion"
echo ""
echo "   Test it:"
echo "   curl 'https://your-domain.com/api/ebay/marketplace-account-deletion?challenge_code=test123'"
echo ""
