        ...
        if rules.get('auto_populate') and rules.get('source_field'):
            ...
            if source_field == '_description_html':
                ...
                if condition_details and condition_details.strip():
                    # Parse condition details into bullet points
                    ...
                    # Default boilerplate
                    condition_html = '<li style="text-align: left;">NM – Like New, Raw, Never Read, Stored Carefully</li><li style="text-align: left;">Please use the photos to judge condition</li>'
                ...
                if photos_details and photos_details.strip():
                    ...
                    # Default boilerplate
                    photos_html = '<li style="text-align: left;">Exact book is pictured</li><li style="text-align: left;">Scans and stand up pictures</li>'
                ...
                html_template = f'''<div style="text-align: center;">
<p class="p1" style="text-align: left;"></p><div style="text-align: left;"><strong style="font-weight: bold; text-align: center;"><div style="text-align: left;"><strong>Title</strong></div></strong><span style="text-align: center;"></span><p style="text-align: center;"></p><p class="p2"></p><ul><li>
<p class="p1">{title}<b></b></p></li></ul><strong>Description</strong><br /><span style="text-align: center;"></span><p class="p1"></p>
<p class="p1"></p><ul>{desc_bullets_html}</ul><b>Condition</b><p></p><p class="p1"></p><ul style="text-align: center;">{condition_html}</ul><div><b>Photos</b><br /><ul style="text-align: center;"></ul></div><ul style="text-align: center;">{photos_html}</ul><p class="p2"></p><p style="text-align: center;"></p><p class="p3"><b>Shipping</b></p><p class="p1"></p><ul style="text-align: center;">{shipping_html}</ul><strong style="font-weight: bold;">{signoff}</strong></div><div style="text-align: left;"></div><p></p></div>'''
